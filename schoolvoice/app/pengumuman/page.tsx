...
export default function PengumumanPage() {
  ...
  // Try to load from Supabase; fall back to dummy data if DB not configured
  useEffect(() => {
    const fetchAnnouncements = async () => {
      try {
        ...
        // If no data or error, keep dummyAnnouncements (already set as default)
      } catch {
        // Supabase not configured – use dummy data (already in state)
      }
    };
    fetchAnnouncements();
  }, []);
