...
export default function PengumumanPage() {
  ...
  // State baru untuk menyimpan data pengumuman dari database
  ...
  useEffect(() => {
    const fetchAnnouncements = async () => {
      ...
      if (data) {
        // Menyesuaikan penamaan field snake_case dari database ke camelCase di frontend
  ...
  // Menggunakan state 'announcements' (bukan dummyAnnouncements lagi)
        ...
        >
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {regular.length > 0 ? (
              ...
              <div className="col-span-full py-10 text-center text-[#6b8f82] text-sm">
